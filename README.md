...
- Lots of safety refactoring to try and clean up any remaining memory issues and crashes. If you get an alert that a fatal error has occured, please report it at https://github.com/Carson-Shook/Winclipper/issues
